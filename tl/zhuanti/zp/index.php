		...
		<div class="class_nav clearfix" >
			<ul class="class_fl active">
				<li class="NetClassCategoryId clearfix active">
					...
					<a href="javascript:void(0)" id="zp" data-id="12">教师招聘</a>
					<a href="javascript:void(0)" id="zgz" data-id="19">教师资格证</a>
					<?php
				...
				<li class="classPhase bx clearfix">
					<em>考试学段</em>
				</li>
				<li class="classType bx clearfix">
					<em>课程班型</em>
				</li>
